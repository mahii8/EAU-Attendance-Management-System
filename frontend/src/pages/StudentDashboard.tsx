...
import { getStudentDashboardApi } from "@/api/axios";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";
import { Badge } from "@/components/ui/badge";
import { Progress } from "@/components/ui/progress";
import { LogOut, ClipboardList, AlertTriangle, CheckCircle, Mail } from "lucide-react";
...
export default function StudentDashboard() {
  ...
  if (!data) {
    return <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center">No data found.</div>;
  }

  const { student, metrics, course_breakdown, history } = data;
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      <main className="max-w-6xl mx-auto p-6 space-y-8 animate-fade-in">
        {/* Welcome Section */}
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Welcome, {student.full_name}</h2>
          <p className="text-slate-500 text-sm mt-1">{student.student_id} · {student.email}</p>
        </div>
            ...
            {course_breakdown.map((course: any, idx: number) => {
              ...
              return (
                <div key={idx} className="space-y-2">
                  ...
                  {/* Custom progress bar to match design (Green filled, yellow edge, gray background) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="shadow-sm border-0 h-fit">
            <CardHeader className="pb-4">
              <CardTitle className="text-base font-semibold">Attendance Policy Legend</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1 leading-relaxed">Counts as Present. Student attended the required session duration.</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1 leading-relaxed">Excused absences include documented medical or emergency reasons. Does not deeply impact rate.</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1 leading-relaxed">Recorded as Late. Excessive tardiness may have academic consequences.</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1 leading-relaxed">Recorded as Absent. This negatively impacts your attendance rate limits.</p>
                </div>
              </div>
            </CardContent>
          </Card>
